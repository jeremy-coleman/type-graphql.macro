...
function generateInstanceTransformationTree(
  target: TypeValue
): TransformationTree | null {
...
export function convertArgsToInstance(
  argsMetadata: ArgsParamMetadata,
  args: ArgsDictionary
) {
